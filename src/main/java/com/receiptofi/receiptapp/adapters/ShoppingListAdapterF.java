...
import com.receiptofi.receiptapp.fragments.ShoppingListFragment;
 ...
 */
public class ShoppingListAdapterF extends ArrayAdapter<ShoppingItemModel> {
    private static final String TAG = ReceiptItemListAdapter.class.getSimpleName();

    private Context context;
    private List<ShoppingItemModel> list;
    private ShoppingListFragment shoppingListActivity;

    public ShoppingListAdapterF(Context context, ShoppingListFragment shoppingListActivity, List<ShoppingItemModel> list) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            if (!itemReceiptModels.isEmpty()) {
                 ...
                 * @see ReceiptItemListAdapter#getView(int, View, ViewGroup)
                 */
