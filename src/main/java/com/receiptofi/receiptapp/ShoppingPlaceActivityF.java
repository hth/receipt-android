 ...
 */
public class ShoppingPlaceActivityF extends Activity implements DialogInterface.OnDismissListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    private void setupView(List<ShoppingPlace> shoppingPlaces) {
        ...
        SwipeMenuCreator creator = new SwipeMenuCreator() {
            ...
            public void create(SwipeMenu menu) {
                // create "open" item
                SwipeMenuItem openItem = new SwipeMenuItem(ShoppingPlaceActivityF.this);
                // set item background
                ...
                // create "delete" item
                SwipeMenuItem deleteItem = new SwipeMenuItem(ShoppingPlaceActivityF.this);
                // set item background
